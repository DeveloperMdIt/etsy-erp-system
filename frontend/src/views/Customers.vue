    ...
    <div class="sticky top-0 z-30 bg-gray-50 pb-4 pt-4">
      <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
          <button @click="fetchCustomers" type="button" class="btn-secondary inline-flex items-center">
      ...
      <div class="mt-4 flex flex-col sm:flex-row gap-4 bg-white p-4 rounded-2xl border border-gray-200 shadow-sm">
        ...
        <div class="flex gap-2">
           <select v-model="sortBy" @change="fetchCustomers" class="rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border px-3 py-2 bg-white">
            <option value="createdAt">Datum</option>
            <option value="customerNumber">Kundennr.</option>
            <option value="lastName">Nachname</option>
          </select>

          <button @click="sortOrder = sortOrder === 'asc' ? 'desc' : 'asc'; fetchCustomers()" class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
            {{ sortOrder === 'asc' ? '↑' : '↓' }}
          </button>
